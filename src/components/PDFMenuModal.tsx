    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <div className="relative bg-gray-50">
          {/* Main Image Display */}
          <div className="relative h-[400px] sm:h-[600px] flex items-center justify-center overflow-hidden">
            ...
            {menuCardImages.length > 1 && (
              <>
                <button
                  onClick={prevSlide}
                  className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-80 hover:bg-opacity-100 rounded-full p-1.5 sm:p-2 shadow-lg transition-all duration-200"
                >
                  <ChevronLeft className="w-5 h-5 sm:w-6 sm:h-6 text-gray-700" />
                </button>
                <button
                  onClick={nextSlide}
                  className="absolute right-2 sm:right-4 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-80 hover:bg-opacity-100 rounded-full p-1.5 sm:p-2 shadow-lg transition-all duration-200"
                >
          ...
          {/* Carousel Indicators */}
          {menuCardImages.length > 1 && (
            <div className="flex justify-center space-x-1 sm:space-x-2 py-3 sm:py-4 bg-white">
          ...
          {menuCardImages.length === 0 && (
            <div className="h-[400px] sm:h-[600px] flex items-center justify-center">
              <div className="text-center px-4">
                <p className="text-gray-500 text-base sm:text-lg mb-3 sm:mb-4">No menu card images available.</p>
